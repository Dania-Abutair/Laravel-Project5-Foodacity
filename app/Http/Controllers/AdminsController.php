...
class AdminsController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('super_admin_auth')->except('totalViews');
    }
    ...
    public function totalViews()
    {
        ...
        $latestUsers     = User::orderBy('id', 'DESC')->get();
        return view('dashboardviews.index', compact('totalPosts', 'totalUsers', 'totalCategories', 'totalLikes', 'latestUsers'));
    }
